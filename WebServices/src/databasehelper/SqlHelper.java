...
public class SqlHelper
{
	 ...
	 * databaseUrl
	 */
	public static String databaseUrl = "jdbc:mysql://192.168.24.246:";
	/**
	 * connection port
	 */
	 ...
	 * database name
	 */
	public static String databaseName = "uwindsor";
	 ...
	 * 
	 * @return if get fail, it will return null. Please check the return value while using it.
	 */
